...
import com.liuye.security.core.validate.code.ValidateCodeGenerator;
...
public class ImageCodeGenerator implements ValidateCodeGenerator {
    ...
    public ImageCode generate(ServletWebRequest request) {
        ...
        String code = generateVerifyCode(securityProperties.getCode().getImage().getLength());
        ...
        for (int i = 0; i < 10/*20*/; i++) {    // #20190803 modify by guoyong  降低干扰
        ...
        // 添加噪点
        float yawpRate = 0.02f;// 噪声率   // #20190803 modify by guoyong  降低噪声
    ...
    public static void main(String[] args) throws IOException {
        File dir = new File("/Users/liuhui/Documents/壁纸/");
        int w = 200, h = 80;
        for(int i = 0; i < 2; i++){
