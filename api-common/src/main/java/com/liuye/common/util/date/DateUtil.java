...
import com.liuye.common.util.string.StringUtil;
...
public class DateUtil {
	static SimpleDateFormat sdfShort = new SimpleDateFormat(
			"yyyyMMdd");
	...
	/**
	 * 获取当前的年和月 ， 返回格式为 yyyy-MM
	 * 
	 * @return
	 */
	public static String getCurrentYear_Month() {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM");// 完整的时间
		return sdf.format(new Date());
	}

	public static String getBeforYear_Month(Date date)
	{
	 ...
	 * @return
	 */
	public static String getLastWeekYear_Month() {
	...
	public static String getFormattedDateUtil(Date dtDate,
			String strFormatTo) {
		if (dtDate == null) {
			return "";
		}
	...
	public static void main(String[] args) {
		try {
			System.out.println(longToString(1512910800000L, "yyyy-MM-dd HH"));
	...
	public static Date dateAddMilliSeconds(Date date, long milliSeconds) {
		long now = date.getTime() + milliSeconds;
		return new Date(now);
	}
	...
	public static  List<Date> getDates(String start, String end) throws ParseException {
		 Calendar p_start = Calendar.getInstance();
	     Calendar p_end = Calendar.getInstance();
	     SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd"); 
	     Date dateStart = dateFormat.parse(start); 
		 Date dataEnd = dateFormat.parse(end);
	     p_start.setTime(dateStart);
	     p_end.setTime(dataEnd);
	     
	     Long startTIme = p_start.getTimeInMillis(); 
	     Long endTime = p_end.getTimeInMillis();  
	 ...
	 public static String getLastDayOfMonth(int year,int month)
	    ...
	    * @throws ParseException 
	    */
	   public static String formartYMD(String strDay) throws ParseException
	   {
		   SimpleDateFormat sdf1 = new SimpleDateFormat("yyyyMMddhhmmss");  
		   Date date = (Date) sdf1.parse(strDay);  
	   ...
	   public static List<String> getYearMonthBetween(String minDate, String maxDate) throws ParseException
	   {
